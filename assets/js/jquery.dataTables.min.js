...
!function (a) {
        ...
        var e = function (b, c, f) {
            ...
            if ("" !== f)for (var k = A(f), l = 0, m = k.length; m > l; l++) {
                if (g = k[l].match(rb), h = k[l].match(sb), g) {
                    if (k[l] = k[l].replace(rb, ""), "" !== k[l] && (b = b[k[l]]), i = [], k.splice(0, l + 1), j = k.join("."), a.isArray(b))for (var n = 0,
                                                                                                                                                      o = b.length; o > n; n++)i.push(e(b[n], c, j));
        ...
        var c = function (b, e, f) {
            for (var g, h, i, j, k, l = A(f), m = l[l.length - 1], n = 0, o = l.length - 1; o > n; n++) {
                if (h = l[n].match(rb), i = l[n].match(sb), h) {
                    if (l[n] = l[n].replace(rb, ""), b[l[n]] = [], g = l.slice(), g.splice(0, n + 1), k = g.join("."), a.isArray(e))for (var p = 0,
                                                                                                                                             q = e.length; q > p; p++)j = {}, c(j, e[p], k), b[l[n]].push(j); else b[l[n]] = e;
                    return
                }
    ...
    function O(b) {
        ...
        for (var h, i, j, k, l, m, n = b.sDom.split(""), o = 0; o < n.length; o++) {
            if (h = null, i = n[o], "<" == i) {
                ...
                g.append(j), g = a(j)
            } else if (">" == i) g = g.parent(); else if ("l" == i && f.bPaginate && f.bLengthChange) h = ka(b); else if ("f" == i && f.bFilter) h = W(b); else if ("r" == i && f.bProcessing) h = na(b); else if ("t" == i) h = pa(b); else if ("i" == i && f.bInfo) h = ea(b); else if ("p" == i && f.bPaginate) h = la(b); else if (0 !== Ua.ext.feature.length)for (var q = Ua.ext.feature,
                                                                                                                                                                                                                                                                                                                                                                            r = 0,
    ...
    function Q(a, b, c) {
        ...
        for (var e = 0, f = c.length; f > e; e++)for (var g = 0,
    ...
    function Y(b) {
        for (var c, d, e = Ua.ext.search, f = b.aiDisplay, g = 0, h = e.length; h > g; g++) {
            for (var i = [], j = 0,
                     k = f.length; k > j; j++)d = f[j], c = b.aoData[d], e[g](b, c._aFilterData, d, c._aData, j) && i.push(d);
            f.length = 0, a.merge(f, i)
        }
    }

    function Z(a, b, c, d, e, f) {
        if ("" !== b)for (var g, h = a.aiDisplay, i = _(b, d, e, f),
                              j = h.length - 1; j >= 0; j--)g = a.aoData[h[j]]._aFilterData[c], i.test(g) || h.splice(j, 1)
    }
    ...
    function ka(b) {
        for (var c = b.oClasses, d = b.sTableId, e = b.aLengthMenu, f = a.isArray(e[0]), g = f ? e[0] : e,
                 h = f ? e[1] : e,
                 i = a("<select/>", {name: d + "_length", "aria-controls": d, "class": c.sLengthSelect}), j = 0,
                 k = g.length; k > j; j++)i[0][j] = new Option(h[j], g[j]);
    ...
    function wa(a, b) {
        for (var c, d = -1, e = -1, f = 0,
                 g = a.aoData.length; g > f; f++)c = y(a, f, b, "display") + "", c = c.replace(vb, ""), c = c.replace(/&nbsp;/g, " "), c.length > d && (d = c.length, e = f);
        return e
    }
    ...
    function Ea(a, b) {
        ...
        for (var f, g, h = Ua.ext.type.order[d.sType + "-pre"], i = 0,
                 j = a.aoData.length; j > i; i++)f = a.aoData[i], f._aSortData || (f._aSortData = []), f._aSortData[b] && !e || (g = e ? c[i] : y(a, i, b, "sort"), f._aSortData[b] = h ? h(g) : g)
    }
    ...
    Wa = function (b, c) {
        ...
        filter: function (a) {
            var b = [];
            if (xb.filter) b = xb.filter.call(this, a, this); else for (var c = 0,
        ...
        map: function (a) {
            var b = [];
            if (xb.map) b = xb.map.call(this, a, this); else for (var c = 0,
    ...
    var Bb = function (b, c, e, f, g) {
        ...
        for (var b = 0,
                 c = a.length; c > b; b++)if (a[b].length > 0)return a[0] = a[b], a[0].length = 1, a.length = 1, a.context = [a.context[b]], a;
        return a.length = 0, a
    }, Eb = function (b, c) {
    ...
    Xa("rows()", function (b, c) {
        ...
        for (var b = [], c = this.context, d = 0, e = c.length; e > d; d++)for (var f = 0,
                                                                                    g = this[d].length; g > f; f++) {
    ...
    var Gb = function (b, c, d, e) {
        var f = [], g = function (c, d) {
            if (a.isArray(c) || c instanceof a)for (var e = 0,
                                                        h = c.length; h > e; e++)g(c[e], d); else if (c.nodeName && "tr" === c.nodeName.toLowerCase()) f.push(c); else {
        ...
        b.off(d + " " + e + " " + f), kb(g, "_details").length > 0 && (b.on(d, function (c, d) {
            ...
            if (a === c)for (var f, h = q(c), i = 0,
                                 j = g.length; j > i; i++)f = g[i], f._details && f._details.children("td[colspan]").attr("colspan", h)
        }), b.on(f, function (c, d) {
    ...
    Xa("cells()", function (b, c, e) {
        ...
        for (var b, c, d = Ua.version.split("."), e = a.split("."), f = 0,
                 g = e.length; g > f; f++)if (b = parseInt(d[f], 10) || 0, c = parseInt(e[f], 10) || 0, b !== c)return b > c;
        return !0
        ...
        oLanguage: {
            ...
            sInfo: "显示 _TOTAL_ 个条目中的 _START_ 到 _END_ 个 ",
            sInfoEmpty: "显示 0 个条目中的 0 到 0 个",
            sInfoFiltered: "(从 _MAX_ 个条目中找)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
