...
!function (a) {
    ...
    "use strict";
    var e = a.fn.dataTable, f = function (a) {
        if ("undefined" == typeof navigator || !/MSIE [1-9]\./.test(navigator.userAgent)) {
            var b = a.document, c = function () {
                return a.URL || a.webkitURL || a
            }, e = b.createElementNS("http://www.w3.org/1999/xhtml", "a"), f = "download" in e, g = function (c) {
            ...
            }, k = "application/octet-stream", l = 0, m = 500, n = function (b) {
                var d = function () {
                ...
                b = p(b);
                var m, q, r, s = this, t = b.type, u = !1, v = function () {
                    o(s, "writestart progress write writeend".split(" "))
                }, w = function () {
                    if (!u && m || (m = c().createObjectURL(b)), q) q.location.href = m; else {
                ...
                return s.readyState = s.INIT, j || (j = "download"), f ? (m = c().createObjectURL(b), e.href = m, e.download = j, g(e), s.readyState = s.DONE, v(), void n(m)) : (a.chrome && t && t !== k && (r = b.slice || b.webkitSlice, b = r.call(b, 0, b.size, k), u = !0), h && "download" !== j && (j += ".download"), (t === k || h) && (q = a), i ? (l += b.size, void i(a.TEMPORARY, l, x(function (a) {
                    a.root.getDirectory("saved", y, x(function (a) {
                        ...
                        a.getFile(j, {create: !1}, x(function (a) {
                            a.remove(), c()
                        }), x(function (a) {
        ...
        for (var c = j(b), e = a.buttons.exportData(b.exportOptions), f = b.fieldBoundary, g = b.fieldSeparator,
                 h = new RegExp(f, "g"), i = b.escapeChar !== d ? b.escapeChar : "\\", k = function (a) {
                for (var b = "", c = 0,
                         d = a.length; d > c; c++)c > 0 && (b += g), b += f ? f + ("" + a[c]).replace(h, i + f) + f : a[c];
                return b
            }, l = b.header ? k(e.header) + c : "", m = b.footer && e.footer ? c + k(e.footer) : "", n = [], o = 0,
                 p = e.body.length; p > o; o++)n.push(k(e.body[o]));
        return {str: l + n.join(c) + m, rows: n.length}
    }, l = function () {
    ...
    return e.ext.buttons.copyHtml5 = {
        className: "buttons-copy buttons-html5", text: function (a) {
            ...
            var g = k(d, f), h = g.str,
                i = a("<div/>").css({height: 1, width: 1, overflow: "hidden", position: "fixed", top: 0, left: 0});
            ...
            var n = a(m).closest(".dt-button-info"), o = function () {
        ...
        action: function (a, b, d, e) {
            var h = (j(e), k(b, e).str), i = e.charset;
            e.customize && (h = e.customize(h, e)), i !== !1 ? (i || (i = c.characterSet || c.charset), i && (i = ";charset=" + i)) : i = "", f(new Blob([h], {type: "text/csv" + i}), g(e))
        },
        filename: "*",
        extension: ".csv",
        exportOptions: {},
        ...
        className: "buttons-excel buttons-html5", available: function () {
            ...
            var k = "", l = e.buttons.exportData(j.exportOptions), n = function (b) {
                for (var c = [], e = 0,
                         f = b.length; f > e; e++)null !== b[e] && b[e] !== d || (b[e] = ""), c.push("number" == typeof b[e] || b[e].match && a.trim(b[e]).match(/^-?\d+(\.\d+)?$/) && "0" !== b[e].charAt(0) ? '<c t="n"><v>' + b[e] + "</v></c>" : '<c t="inlineStr"><is><t>' + (b[e].replace ? b[e].replace(/&(?!amp;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "") : b[e]) + "</t></is></c>");
                return "<row>" + c.join("") + "</row>"
            };
            j.header && (k += n(l.header));
            for (var o = 0, p = l.body.length; p > o; o++)k += n(l.body[o]);
            j.footer && (k += n(l.footer));
            var q = new b.JSZip, r = q.folder("_rels"), s = q.folder("xl"), t = q.folder("xl/_rels"),
        ...
        action: function (c, d, e, h) {
            var k = (j(h), d.buttons.exportData(h.exportOptions)), m = [];
            ...
            for (var n = 0, o = k.body.length; o > n; n++)m.push(a.map(k.body[n], function (a) {
                return {text: "string" == typeof a ? a : a + "", style: n % 2 ? "tableBodyEven" : "tableBodyOdd"}
            }));
            ...
            "open" !== h.download || l() ? q.getBuffer(function (a) {
                var b = new Blob([a], {type: "application/pdf"});
                f(b, g(h))
            }) : q.open()
        },
        title: "*",
