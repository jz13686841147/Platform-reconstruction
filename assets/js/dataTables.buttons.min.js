...
!function (a) {
    ...
    "use strict";
    var e = a.fn.dataTable, f = 0, g = 0, h = e.ext.buttons, i = function (b, c) {
        c === !0 && (c = {}), a.isArray(c) && (c = {buttons: c}), this.c = a.extend(!0, {}, i.defaults, c), c.buttons && (this.c.buttons = c.buttons), this.s = {
            dt: new e.Api(b),
            buttons: [],
            subButtons: [],
            listenKeys: "",
            namespace: "dtb" + f++
        }, this.dom = {container: a("<" + this.c.dom.container.tag + "/>").addClass(this.c.dom.container.className)}, this._constructor()
    };
    a.extend(i.prototype, {
        action: function (a, b) {
            ...
            var c = this._indexToButton(a), e = this.c.dom.button.active;
            ...
            var b, c, d, e, f = this.s.buttons, g = this.s.subButtons;
            ...
            for (b = 0, c = h.length; c > b; b++)if (h.inst === this) {
                h.splice(b, 1);
                break
            }
            return this
            ...
            var a, b, c, d = this.s.buttons, e = this.s.subButtons;
            ...
            var c = this._indexToButton(a), e = this.c.dom.collection.buttonLiner,
                f = "string" == typeof a && -1 !== a.indexOf("-") && e && e.tag ? e.tag : this.c.dom.buttonLiner.tag,
                g = this.s.dt, h = function (a) {
            ...
            var b = this, d = this.s.dt, e = d.settings()[0];
            ...
            for (var h = 0, i = b.length; i > h; h++) {
                ...
                if (j)if (a.isArray(j)) this._buildButtons(j, c, e); else {
            ...
            var d = this.c.dom.button, e = this.c.dom.buttonLiner, f = this.c.dom.collection, h = this.s.dt,
                i = function (a) {
            ...
            var d, e, f, g, h = this.s.buttons, i = this.s.subButtons, j = function (d, e) {
                if (d.key)if (d.key === b) e.click(); else if (a.isPlainObject(d.key)) {
            ...
            if (b.key) {
                var c = a.isPlainObject(b.key) ? b.key.key : b.key, d = this.s.listenKeys.split(""),
                    e = a.inArray(c, d);
                d.splice(e, 1), this.s.listenKeys = d.join("")
            }
        }, _resolveExtends: function (b) {
            var c, e, f = this.s.dt, g = function (c) {
        ...
        var d = [], e = a.map(c, function (a) {
            return a.name
        }), f = function (b) {
            if (a.isArray(b))for (var g = 0,
                                      h = b.length; h > g; g++)f(b[g]); else if ("string" == typeof b)if (-1 !== b.indexOf(",")) f(b.split(",")); else {
        ...
        for (var e = [], f = function (b, c) {
            ...
            if (a.isArray(b) || b instanceof a)for (g = 0, h = b.length; h > g; g++)f(b[g], c); else if (null === b || b === d || "*" === b)for (g = 0, h = i.length; h > g; g++)e.push({
                inst: c,
                idx: c.toIndex(i[g].node)
            }); else if ("number" == typeof b) e.push({
                inst: c,
                idx: b
            }); else if ("string" == typeof b)if (-1 !== b.indexOf(",")) {
                var k = b.split(",");
                for (g = 0, h = k.length; h > g; g++)f(a.trim(k[g]), c)
            } else if (b.match(/^\d+(\-\d+)?$/)) e.push({inst: c, idx: b}); else if (-1 !== b.indexOf(":name")) {
        ...
        collection: {
            ...
            action: function (d, e, f, g) {
                var h = f, j = h.offset(), k = a(e.table().container()), l = !1;
                ...
                if (l && "absolute" === m) g._collection.css({
                    ...
                    var n = j.left + g._collection.outerWidth(), o = k.offset().left + k.width();
            ...
            var d = b.settings()[0].aLengthMenu, e = a.isArray(d[0]) ? d[0] : d, f = a.isArray(d[0]) ? d[1] : d,
                g = function (a) {
            ...
            return {
                ...
                buttons: a.map(e, function (a, b) {
                    return {
                        text: f[b], action: function (b, c, d, e) {
                            c.page.len(a).draw()
                        }, init: function (b, c, d) {
    ...
    var k = a("<textarea/>")[0], l = function (b, c) {
        for (var d = a.extend(!0, {}, {
            ...
            }).toArray() : null, h = b.rows(d.rows, d.modifier).indexes().toArray(),
                 i = b.cells(h, d.columns).render(d.orthogonal).toArray(), j = f.length, l = j > 0 ? i.length / j : 0,
                 m = new Array(l), n = 0, o = 0, p = l; p > o; o++) {
    ...
    return a.fn.dataTable.Buttons = i, a.fn.DataTable.Buttons = i, a(c).on("init.dt plugin-init.dt", function (a, b, c) {
        ...
        fnInit: function (a) {
            var b = new e.Api(a), c = b.init().buttons || e.defaults.buttons;
