...
!function (a) {
    ...
    return function (a) {
        ...
        (function (b) {
            ...
            function e(a, b) {
                var c = {theme: A(E.settings.themes.gray, null), stylesheets: b.stylesheets, instanceOptions: b},
                    d = a.indexOf("?"), e = [a];
            ...
            function f(a) {
                var b = a.mode, c = a.el, d = a.flags, e = a.engineSettings, f = d.dimensions, h = d.theme,
            ...
            function g(a) {
                ...
                var j = {width: g.dimensions.width, height: g.dimensions.height, theme: g.theme, flags: g.flags},
                    k = h(j);
            ...
            function h(a) {
                ...
                var d = a.flags.lineWrap || E.setup.lineWrapRatio, e = a.width * d, f = e,
                    g = new s({width: a.width, height: a.height}), h = g.Shape,
            ...
            function i(a, b, c, d) {
                var e = parseInt(a, 10), f = parseInt(b, 10), g = Math.max(e, f), h = Math.min(e, f),
                    i = .8 * Math.min(h, g * d);
            ...
            var q = c(2), r = c(3), s = c(10), t = c(11), u = c(12), v = c(13), w = c(14), x = c(15), y = c(16),
                z = c(19), A = t.extend, B = t.dimensionCheck, C = x.svg_ns, D = {
                    version: x.version, addTheme: function (a, b) {
                        ...
                        var h = v.getNodeArray(g.images), i = v.getNodeArray(g.bgnodes), j = v.getNodeArray(g.stylenodes),
                        ...
                        return c.stylesheets = [], c.svgXMLStylesheet = !0, c.noFontFallback = g.noFontFallback ? g.noFontFallback : !1, j.forEach(function (a) {
                            ...
                            if (b.getComputedStyle) {
                                var d = b.getComputedStyle(a, null).getPropertyValue("background-image"),
                                    h = a.getAttribute("data-background-src"), i = h || d, j = null, k = g.domain + "/",
                                    l = i.indexOf(k);
                            ...
                            var f = null != b.src, h = null != b.dataSrc && 0 === b.dataSrc.indexOf(g.domain),
                    ...
                    return function (d) {
                        ...
                        if (E.setup.supportsSVG) {
                            ...
                            var j = b.getBBox(), k = Math.ceil(j.width / e.properties.width), l = i.text.split(" "),
                                m = i.text.match(/\\n/g);
                            k += null == m ? 0 : m.length, c.nodeValue = i.text.replace(/[ ]+/g, "");
                            var n = b.getComputedTextLength(), o = j.width - n,
                                p = Math.round(o / Math.max(1, l.length - 1)), q = [];
                            if (k > 1) {
                                c.nodeValue = "";
        ...
        function c(a) {
            ...
            var g = a.document, h = g.documentElement, i = "load", j = !1, k = "on" + i, l = "complete",
                m = "readyState", n = "attachEvent", o = "detachEvent", p = "addEventListener", q = "DOMContentLoaded",
                r = "onreadystatechange", s = "removeEventListener", t = p in g, u = j, v = j, w = [];
        ...
        (function (a, d) {
            ...
            function J(a, b, c, d) {
                0 > b && (b = 65535 + b + 1);
                for (var e = 0,
                         f = Math.min(a.length - c, 2); f > e; e++)a[c + e] = (b & 255 << 8 * (d ? e : 1 - e)) >>> 8 * (d ? e : 1 - e)
            }
            ...
            function T(a, b) {
                for (var c, d, e, f = [],
                         g = 0; g < a.length && !((b -= 2) < 0); g++)c = a.charCodeAt(g), d = c >> 8, e = c % 256, f.push(e), f.push(d);
                return f
            }
        ...
        !function (a) {
            ...
            var f = "undefined" != typeof Uint8Array ? Uint8Array : Array, g = "+".charCodeAt(0), h = "/".charCodeAt(0),
                i = "0".charCodeAt(0), j = "a".charCodeAt(0), k = "A".charCodeAt(0), l = "-".charCodeAt(0),
                m = "_".charCodeAt(0);
        ...
        (function (a) {
            b.extend = function (a, b) {
                ...
                for (var b = [], c = 0,
                         d = a.length - 1; d >= 0; d--)c = a.charCodeAt(d), c > 128 ? b.unshift(["&#", c, ";"].join("")) : b.unshift(a[d]);
                return b.join("")
                ...
                var b, c = /(^(?:#?)[0-9a-f]{6}$)|(^(?:#?)[0-9a-f]{3}$)/i,
                    ...
                    e = /^rgba\((\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(0\.\d{1,}|1)\)$/, f = a.match(c);
        ...
        c.rgb2hex = function (a, b, c) {
            ...
            var d = a / 60, e = (1 - Math.abs(2 * c - 1)) * b, f = e * (1 - Math.abs(parseInt(d) % 2 - 1)),
                g = c - e / 2, h = 0, i = 0, j = 0;
            ...
            this.raw = a;
            var b = (16711680 & this.raw) >> 16, c = (65280 & this.raw) >> 8, d = 255 & this.raw,
                e = .2126 * b + .7152 * c + .0722 * d, f = -.09991 * b - .33609 * c + .436 * d,
                g = .615 * b - .55861 * c - .05639 * d;
            return this.rgb = {r: b, g: c, b: d}, this.yuv = {y: e, u: f, v: g}, this
        }, c.prototype.lighten = function (a) {
            var b = Math.min(1, Math.max(0, Math.abs(a))) * (0 > a ? -1 : 1), d = 255 * b | 0,
                e = Math.min(255, Math.max(0, this.rgb.r + d)), f = Math.min(255, Math.max(0, this.rgb.g + d)),
                g = Math.min(255, Math.max(0, this.rgb.b + d)), h = c.rgb2hex(e, f, g);
            return new c(h)
            ...
            var b = a, d = this, e = b.alpha * b.rgb.r + (1 - b.alpha) * d.rgb.r,
                f = b.alpha * b.rgb.g + (1 - b.alpha) * d.rgb.g, g = b.alpha * b.rgb.b + (1 - b.alpha) * d.rgb.b;
        ...
        a.exports = function (a, b) {
            ...
            Object.keys(o.children).forEach(function (a) {
                ...
                Object.keys(b.children).forEach(function (a) {
                    var c = b.children[a], d = o.x + b.x + c.x, e = o.y + b.y + c.y,
                        f = l.element({tag: "text", content: c.properties.text, x: d, y: e});
                    q.push(f)
                })
            });
            ...
            var w = l.element({tag: "g", id: m, content: v}),
                x = l.element({tag: "style", content: p, type: "text/css"}), y = l.element({tag: "defs", content: x}),
                z = l.element({
                    tag: "svg",
                    content: [y, w],
        ...
        a.exports = function d(a, b, c) {
            "use strict";
            function e(a) {
                var b = a.match(/^[\w-]+/), d = {tag: b ? b[0] : "div", attr: {}, children: []},
            ...
            return function (c) {
                ...
                for (var m in l.children) {
                    ...
                    for (var o in n.children) {
                        var p = n.children[o], q = d * (l.x + n.x + p.x),
