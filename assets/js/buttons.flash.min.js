...
!function (a) {
    ...
    f.Client.prototype = {
        ...
        receiveEvent: function (a, d) {
            ...
            if (this.handlers[a])for (var f = 0, g = this.handlers[a].length; g > f; f++) {
    ...
    var g = function (a, b) {
        ...
        for (var c = l(b), e = a.buttons.exportData(b.exportOptions), f = b.fieldBoundary, g = b.fieldSeparator,
                 h = new RegExp(f, "g"), i = b.escapeChar !== d ? b.escapeChar : "\\", j = function (a) {
                for (var b = "", c = 0,
                         d = a.length; d > c; c++)c > 0 && (b += g), b += f ? f + ("" + a[c]).replace(h, i + f) + f : a[c];
                return b
            }, k = b.header ? j(e.header) + c : "", m = b.footer && e.footer ? c + j(e.footer) : "", n = [], o = 0,
                 p = e.body.length; p > o; o++)n.push(j(e.body[o]));
        return {str: k + n.join(c) + m, rows: n.length}
    }, n = {
        available: function () {
            return f.hasFlash()
        },
    ...
    return e.Buttons.swfPath = "assets/swf/flashExport.swf", e.Api.register("buttons.resize()", function () {
        ...
        className: "buttons-copy buttons-flash", text: function (a) {
            ...
            if (d._fromFlash) {
                var e = d._flash, f = m(b, d), g = d.customize ? d.customize(f.str, d) : f.str;
        ...
        className: "buttons-excel buttons-flash", text: function (a) {
            ...
            var g = "", j = f._flash, l = c.buttons.exportData(f.exportOptions), m = function (b) {
                for (var c = [], e = 0,
                         f = b.length; f > e; e++)null !== b[e] && b[e] !== d || (b[e] = ""), c.push("number" == typeof b[e] || b[e].match && a.trim(b[e]).match(/^-?\d+(\.\d+)?$/) && "0" !== b[e].charAt(0) ? '<c t="n"><v>' + b[e] + "</v></c>" : '<c t="inlineStr"><is><t>' + (b[e].replace ? b[e].replace(/&(?!amp;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/[\x00-\x1F\x7F-\x9F]/g, "") : b[e]) + "</t></is></c>");
        ...
        className: "buttons-pdf buttons-flash", text: function (a) {
            ...
            var e = d._flash, f = b.buttons.exportData(d.exportOptions), g = b.table().node().offsetWidth,
