...
!function (a) {
    ...
    o.select = {}, o.select.version = "1.1.2", o.select.init = function (b) {
        ...
        o.ext.selector[b.type].push(function (a, c, e) {
            ...
            if (g === d)return e;
            for (var i = 0,
                     j = e.length; j > i; i++)f = a[b.prop][e[i]], (g === !0 && f._select_selected === !0 || g === !1 && !f._select_selected) && h.push(e[i]);
            return h
        })
        ...
        if (f === d)return c;
        for (var h = 0,
                 i = c.length; i > h; h++)e = a.aoData[c[h].row], (f === !0 && e._selected_cells && e._selected_cells[c[h].column] === !0 || f === !1 && (!e._selected_cells || !e._selected_cells[c[h].column])) && g.push(c[h]);
        return g
    });
